...
public class windowName extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please insert your Name and press \"OK\"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(windowName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new windowName().setVisible(true);
