...
if(!Session::exists(Config::get('session/session_name'))){
  ...
  $bookingLog = new BookingLog('12345');
  $useremails = array();
  foreach ($bookingLog->data() as $key => $value) {
      if ($value->mailID != '0') {
          $mailbox = new Mailbox($value->mailID);
          $useremails[] = $mailbox->data();
      }
  }
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_inbox_url()) . '?lang=1' ;?>">
          ...
          <!-- English Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_inbox_url()) . '?lang=2' ;?>">
          ...
          <!-- French Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_inbox_url()) . '?lang=3' ;?>">
          ...
          <!-- Dutch Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_inbox_url()) . '?lang=4' ;?>">
				...
				<div class="row">
			        ...
			        <div class="col-md-9">
			          <div class="box box-primary">
			            <div class="box-header with-border">
			              <h3 class="box-title"><?php echo INBOX; ?></h3>
			              <!-- /.box-tools -->
			            </div>
			            <!-- /.box-header -->
			            <div class="box-body no-padding">
                          ...
                          ?>
			                  ...
			                  <tr>
			                    ...
			                    <td class="mailbox-subject"><a href="<?php
                                                              if (isset($_GET['lang'])) {
                                                                echo URL::clearQuery(mailbox_url()) . '?mail='.$v->id.'&lang=' . escape($_GET['lang']);
                                                              }else{
                                                                echo URL::clearQuery(mailbox_url()) . '?mail='.$v->id;
                                                              }?>"><b><?=$v->Titel;?></b> - <?=substr($v->Body, 0, 40)?>...</a>
			                    </td>
                          <?php 
