...
if(!Session::exists(Config::get('session/session_name'))){
  ...
  foreach ($_SESSION['outbox_mail'] as $key => $value) {
      $outbox_ids[] = $value->ID;
  }
  if (!in_array($mailid, $outbox_ids)) {
    Redirect::to(403);
  }else{
    $mailbox = new Outbox($mailid);
  }
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outboxread_url()) . "?mail=".escape(Input::get('mail'))."&lang=1" ;?>">
          ...
          <!-- English Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outboxread_url()) . "?mail=".escape(Input::get('mail'))."&lang=2" ;?>">
          ...
          <!-- French Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outboxread_url()) . "?mail=".escape(Input::get('mail'))."&lang=3" ;?>">
          ...
          <!-- Dutch Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outboxread_url()) . "?mail=".escape(Input::get('mail'))."&lang=4" ;?>">
        ...
        <div class="col-md-3">
          ...
          <a href="<?php 
                      if (isset($_GET['lang'])) {
                        ...
                        echo URL::clearQuery(mailbox_outbox_url());
                      }?>" class="btn btn-warning btn-block margin-bottom"><i class="fa fa-reply"></i> <?php echo BACK_TO_OUTBOX; ?></a>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3><?=$mailbox->firstresult()->Betreff;?></h3>
                <h5><?php echo FROM; ?>: <?=$customer->data()->EMail;?>
                  <span class="mailbox-read-time pull-right"><?=$mailbox->firstresult()->DatumZeit;?></span></h5>
              </div>
              <!-- /.mailbox-read-info -->
              <div class="mailbox-read-message">
                <p><?php echo nl2br($mailbox->firstresult()->Nachricht); ?></p>
              </div>
