...
if(!Session::exists(Config::get('session/session_name'))){
  ...
  $outbox = new Outbox('12345');
  if (isset($_SESSION['outbox_mail'])) {
    unset($_SESSION['outbox_mail']);
  }
  $_SESSION['outbox_mail'] = $outbox->data();
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outbox_url()) . '?lang=1' ;?>">
          ...
          <!-- English Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outbox_url()) . '?lang=2' ;?>">
          ...
          <!-- French Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outbox_url()) . '?lang=3' ;?>">
          ...
          <!-- Dutch Flag -->
          <li class="dropdown messages-menu">
            <a href="<?php echo URL::clearQuery(mailbox_outbox_url()) . '?lang=4' ;?>">
        ...
        <div class="row">
              ...
              <div class="col-md-9">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title"><?php echo SENT_EMAILS; ?></h3>
                    <!-- /.box-tools -->
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body no-padding">
                    <div class="table-responsive mailbox-messages">
                      <table class="table table-hover table-striped">
                        ...
                        <tbody>
                        <?php foreach ($outbox->data() as $key => $value) {
                          ?>
                        ...
                        <tr>
                          ...
                          <td class="mailbox-subject"><a href="<?php
                                                              if (isset($_GET['lang'])) {
                                                                echo URL::clearQuery(mailbox_outboxread_url()) . '?mail='.$value->ID.'&lang=' . escape($_GET['lang']);
                                                              }else{
                                                                echo URL::clearQuery(mailbox_outboxread_url()) . '?mail='.$value->ID;
                                                              }?>"><b><?=$value->Betreff;?></b> - <?=substr($value->Nachricht, 0, 40)?>...</a>
                          </td>
                          <?php 
                            $datefromdb = Date::extractDate($value->DatumZeit);
                            $today = date('Y-m-d');
