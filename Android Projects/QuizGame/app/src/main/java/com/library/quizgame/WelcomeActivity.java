...
import adapters.WelcomeScreenFragment;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    Button btnDone;
    ImageButton btnNext;
    boolean isOpaque = true, userSaw = false, userResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadFromPrefs();
        StringGenerator.setLocale(langText, WelcomeActivity.this);
        if (userResult){
            endTutorial();
        }
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if (position == Constants.TOTAL_PAGES - 2 && positionOffset > 0) {
                    if (isOpaque) {
            ...
            public void onPageSelected(int position) {
                if (position == Constants.TOTAL_PAGES - 1) {
                    btnSkip.setVisibility(View.GONE);
                    btnNext.setVisibility(View.GONE);
                    btnDone.setVisibility(View.VISIBLE);
                } else if (position < Constants.TOTAL_PAGES - 2) {
                    btnSkip.setVisibility(View.VISIBLE);
                    btnNext.setVisibility(View.VISIBLE);
                    btnDone.setVisibility(View.GONE);
                } else if (position == Constants.TOTAL_PAGES - 1) {
                    endTutorial();
                }
            }
    ...
    private void loadFromPrefs() {
        ...
        sharedPreferencesUser = getSharedPreferences(Constants.USER_SAW_WELCOME_ACTIVITY, MODE_PRIVATE);
        userResult = sharedPreferencesUser.getBoolean(Constants.USER_SAW, false);
    }
    ...
    private void endTutorial() {
        ...
        userSaw = true;
        sharedPreferences = getSharedPreferences(Constants.USER_SAW_WELCOME_ACTIVITY, MODE_PRIVATE);
        editor = sharedPreferences.edit();
        editor.putBoolean(Constants.USER_SAW, userSaw);
        editor.apply();
