...
public class XDABaseAdapter extends BaseAdapter{
    private LayoutInflater layoutInflater;
    private ArrayList<XDAObject> postValueArrayList;

    public XDABaseAdapter(Context context, ArrayList<XDAObject> postValueArrayList) {
    ...
    @Override
    public XDAObject getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        XDAObject postValue = getItem(position);
