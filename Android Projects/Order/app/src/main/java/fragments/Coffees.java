...
public class Coffees extends Fragment{
    ...
    private String name, image, price, table;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)rootView.findViewById(R.id.coffeesRecyclerView);
        checkOrientation();
    ...
    private void registerCallClickBack() {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity().getApplicationContext(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra(Constants.COFFEE_NAME, customList.get(position).getName());
                intent.putExtra(Constants.COFFEE_PRICE, customList.get(position).getPrice());
                intent.putExtra(Constants.COFFEE_IMAGE, customList.get(position).getImage());
    ...
    public class JsonReadTask extends AsyncTask<String , Void, List<ProductList>> {
        ...
        protected List<ProductList> doInBackground(String... params) {
            try {
                ...
                jsonMainNode = jsonResponse.optJSONArray(Constants.COFFEE_JSON_ARRAY);
    ...
    public void accessWebService() {
        ...
        task.execute(Constants.COFFEES_URL);
    }
