...
public class Vodkas extends ActionBarActivity {
    ...
    private String url = "http://reservations.cretantaxiservices.gr/files/getvodkas.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vodkas);
        ...
        if (!network_connected) {
            DialogMessageDisplay.displayWifiSettingsDialog(Vodkas.this, Vodkas.this, "No Internet Connection", "Please connect to the Internet", AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
        } else {
        ...
        comments = (EditText)findViewById(R.id.editText_vodka);
        cart = (Button)findViewById(R.id.button_vodkas);
    ...
    private void buildRefreshmentsSpinner() {
        ...
        adapter = new ArrayAdapter<>(Vodkas.this, R.layout.spinner_layout, R.id.spinner_ref_id,refreshments);
    ...
    public class JsonReadTask extends AsyncTask<String , Void, List<SpiritList>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Vodkas.this, ProgressDialog.THEME_DEVICE_DEFAULT_DARK);
        ...
        protected List<SpiritList> doInBackground(String... params) {
            ...
            try {
                ...
                JSONArray jsonMainNode = jsonResponse.optJSONArray("vodkas");
