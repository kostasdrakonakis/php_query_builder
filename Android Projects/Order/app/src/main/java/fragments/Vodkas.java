...
public class Vodkas extends AppCompatActivity {
    ...
    public class JsonReadTask extends AsyncTask<String , Void, List<SpiritList>> {
        ...
        protected List<SpiritList> doInBackground(String... params) {
            try {
                ...
                jsonMainNode = jsonResponse.optJSONArray(Constants.VODKAS_JSON_ARRAY);
    ...
    private void setupDataToDB() {
        nameValuePairs.add(new BasicNameValuePair(Constants.PRODUCT_NAME_VALUE_PAIR, vodkaPreference));
    ...
    public void readDataWebService() {
        ...
        task.execute(Constants.VODKAS_URL);
    }
