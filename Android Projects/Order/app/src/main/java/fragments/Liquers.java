...
public class Liquers extends ActionBarActivity {
    ...
    private String url = "http://reservations.cretantaxiservices.gr/files/getliquers.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liquers);
        ...
        if (!network_connected) {
            DialogMessageDisplay.displayWifiSettingsDialog(Liquers.this, Liquers.this, "No Internet Connection", "Please connect to the Internet", AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
        } else {
    ...
    public class JsonReadTask extends AsyncTask<String , Void, List<SpiritList>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Liquers.this, ProgressDialog.THEME_DEVICE_DEFAULT_DARK);
