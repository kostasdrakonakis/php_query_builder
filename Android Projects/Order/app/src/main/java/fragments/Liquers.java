...
public class Liquers extends AppCompatActivity {
    ...
    private String servitoros_id, magazi_id, table, title, quantityPreference, comment, componentPreference, liquerPreference, glassPreference, strollPreference, name, image, price;
    ...
    private void getSpinnerSelectedPreference() {
        spDrinks.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                liquerPreference = customSpinner.get(position).getName();
    ...
    private void checkQuantity() {
        quantity = (EditText) findViewById(R.id.quantityEditTextLiquer);
        plus = (Button) findViewById(R.id.buttonPlusLiquer);
        minus = (Button) findViewById(R.id.buttonMinusLiquer);
        sxolia = (EditText)findViewById(R.id.editTextLiquersComments);
        cart = (Button)findViewById(R.id.cartButtonLiquer);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (glassPreference == null) {
                    Toast.makeText(Liquers.this, getString(R.string.glass_required), Toast.LENGTH_LONG).show();
                } else if (strollPreference == null) {
                    Toast.makeText(Liquers.this, getString(R.string.stroll_required), Toast.LENGTH_LONG).show();
                } else {
                    writeDataWebService();
                }
    ...
    public class JsonReadTask extends AsyncTask<String , Void, List<SpiritList>> {
        ...
        protected List<SpiritList> doInBackground(String... params) {
            try {
                ...
                jsonResult = StringGenerator.inputStreamToString(in, Liquers.this);
    ...
    private class MyInsertDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            try {
                ...
                jsonResult = StringGenerator.inputStreamToString(inputStream, Liquers.this);
                jsonResponse = new JSONObject(jsonResult.toString());
        ...
        protected void onPostExecute(Boolean aVoid) {
            ...
            pDialog.dismiss();
            if (aVoid){
                Toast.makeText(Liquers.this, getString(R.string.cart_addition_successfull), Toast.LENGTH_LONG).show();
                Liquers.this.finish();
            }else{
                Toast.makeText(Liquers.this, "There was a problemm adding this product to the cart. Please try again", Toast.LENGTH_LONG).show();
            }
    ...
    private void setupDataToDB() {
        ...
        try {
            dataToWrite.put(""+Constants.PRODUCT_NAME_POST+"", liquerPreference);
