...
public class Tequilas extends AppCompatActivity {
    ...
    private String servitoros_id, magazi_id, table, title, quantityPreference, comment, componentPreference, tequilaPreference, glassPreference, strollPreference, name, image, price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tequilas);
        populateToolBar();
        spDrinks = (Spinner)findViewById(R.id.flavor_tequila_spinner);
    ...
    private void getSpinnerSelectedPreference() {
        spDrinks.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tequilaPreference = customSpinner.get(position).getName();
    ...
    private void checkQuantity() {
        quantity = (EditText) findViewById(R.id.quantityEditTextTequilas);
        plus = (Button) findViewById(R.id.buttonPlusTequilas);
        minus = (Button) findViewById(R.id.buttonMinusTequilas);
        sxolia = (EditText)findViewById(R.id.editTextTequilaComments);
        cart = (Button)findViewById(R.id.cartButtonTequila);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (glassPreference == null) {
                    Toast.makeText(Tequilas.this, getString(R.string.glass_required), Toast.LENGTH_LONG).show();
                } else if (strollPreference == null) {
                    Toast.makeText(Tequilas.this, getString(R.string.stroll_required), Toast.LENGTH_LONG).show();
                } else {
                    writeDataWebService();
                }
    ...
    private void checkNetworkInfo() {
        ...
        if (!network_connected) {
            DialogMessageDisplay.displayWifiSettingsDialog(Tequilas.this, Tequilas.this, getString(R.string.wifi_off_title), getString(R.string.wifi_off_message));
        } else {
    ...
    private void buildRefreshmentsSpinner() {
        componentAdapter = new SpiritComponentAdapter(Tequilas.this, components);
    ...
    public class JsonReadTask extends AsyncTask<String , Void, List<SpiritList>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Tequilas.this);
        ...
        protected List<SpiritList> doInBackground(String... params) {
            try {
                ...
                jsonResult = StringGenerator.inputStreamToString(in, Tequilas.this);
                customSpinner = new ArrayList<>();

                jsonResponse = new JSONObject(jsonResult.toString());
                jsonMainNode = jsonResponse.optJSONArray(Constants.TEQUILAS_JSON_ARRAY);
    ...
    private class MyInsertDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            try {
                ...
                jsonResult = StringGenerator.inputStreamToString(inputStream, Tequilas.this);
                jsonResponse = new JSONObject(jsonResult.toString());
        ...
        protected void onPostExecute(Boolean aVoid) {
            ...
            pDialog.dismiss();
            if (aVoid){
                Toast.makeText(Tequilas.this, getString(R.string.cart_addition_successfull), Toast.LENGTH_LONG).show();
                Tequilas.this.finish();
            }else{
                Toast.makeText(Tequilas.this, "There was a problemm adding this product to the cart. Please try again", Toast.LENGTH_LONG).show();
            }
    ...
    private void setupDataToDB() {
        ...
        try {
            dataToWrite.put(""+Constants.PRODUCT_NAME_POST+"", tequilaPreference);
    ...
    public void readDataWebService() {
        ...
        task.execute(Constants.TEQUILAS_URL);
    }
    ...
    public void ListDrawer(List<SpiritList> customSpinner) {
        adapterGins = new SpiritsListAdapter(Tequilas.this ,customSpinner);
